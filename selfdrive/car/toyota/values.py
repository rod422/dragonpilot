...
class CAR:
  ...
  LEXUS_LMH_TSS2 = "LEXUS LM HYBRID 2020~2022"
  LEXUS_LMH23_TSS2 = "LEXUS LM HYBRID 2023"
...
CAR_INFO: Dict[str, Union[ToyotaCarInfo, List[ToyotaCarInfo]]] = {
  ...
  CAR.LEXUS_LMH23_TSS2: ToyotaCarInfo("Lexus LM Hybrid 2023"),
}
...
FW_VERSIONS = {
  ...
  CAR.LEXUS_LMH23_TSS2: {
    ...
    (Ecu.abs, 0x7b0, None): [
      b'F152658431\x00\x00\x00\x00\x00\x00',
    ],
    (Ecu.fwdRadar, 0x750, 0xf): [
      b'\x018821F3301400\x00\x00\x00\x00',
    ],
...
DBC = {
  ...
  CAR.LEXUS_LMH_TSS2: dbc_dict('toyota_nodsu_pt_generated', 'toyota_tss2_adas'),
  CAR.LEXUS_LMH23_TSS2: dbc_dict('toyota_nodsu_pt_generated', 'toyota_tss2_adas'),  
}
...
TSS2_CAR = {CAR.RAV4_TSS2, CAR.RAV4_TSS2_2022, CAR.RAV4_TSS2_2023, CAR.COROLLA_TSS2, CAR.COROLLAH_TSS2, CAR.LEXUS_ES_TSS2, CAR.LEXUS_ESH_TSS2, CAR.RAV4H_TSS2, CAR.RAV4H_TSS2_2022,
            ...
            CAR.MIRAI, CAR.LEXUS_NX_TSS2, CAR.LEXUS_NXH_TSS2, CAR.ALPHARD_TSS2, CAR.AVALON_TSS2, CAR.AVALONH_TSS2, CAR.ALPHARDH_TSS2, CAR.CHR_TSS2, CAR.CHRH_TSS2, CAR.LEXUS.LMH_TSS2, CAR.LEXUS.LMH23_TSS2}
...
EV_HYBRID_CAR = {CAR.AVALONH_2019, CAR.AVALONH_TSS2, CAR.CAMRYH, CAR.CAMRYH_TSS2, CAR.CHRH, CAR.CHRH_TSS2, CAR.COROLLAH_TSS2, CAR.HIGHLANDERH, CAR.HIGHLANDERH_TSS2, CAR.PRIUS,
                 ...
                 CAR.LEXUS_RXH_TSS2, CAR.LEXUS_NXH_TSS2, CAR.PRIUS_TSS2, CAR.ALPHARDH_TSS2, CAR.LEXUS.LMH_TSS2, CAR.LEXUS.LMH23_TSS2}
