...
FW_VERSIONS = {
  ...
  CAR.LEXUS_CTH_SNG: {(Ecu.esp, 0xfff, None): [b'\x00']},
  CAR.AVALON: {
    (Ecu.esp, 0x7b0, None): [
...
DBC = {
  ...
  CAR.LEXUS_CTH_SNG: dbc_dict('toyota_new_mc_pt_generated', 'toyota_adas'),
}

# These cars have non-standard EPS torque scale factors. All others are 73
EPS_SCALE = defaultdict(lambda: 73, {CAR.PRIUS: 66, CAR.COROLLA: 88, CAR.LEXUS_IS: 77, CAR.LEXUS_RC: 77, CAR.LEXUS_CTH: 100, CAR.LEXUS_CTH_SNG: 100, CAR.PRIUS_V: 88, CAR.LEXUS_ISH: 130})
...
EV_HYBRID_CAR = {CAR.AVALONH_2019, CAR.CAMRYH, CAR.CAMRYH_TSS2, CAR.CHRH, CAR.COROLLAH_TSS2, CAR.HIGHLANDERH, CAR.HIGHLANDERH_TSS2, CAR.PRIUS,
                 CAR.PRIUS_V, CAR.RAV4H, CAR.RAV4H_TSS2, CAR.LEXUS_CTH, CAR.LEXUS_CTH_SNG, CAR.MIRAI, CAR.LEXUS_ESH, CAR.LEXUS_ESH_TSS2, CAR.LEXUS_NXH, CAR.LEXUS_RXH,
                 CAR.LEXUS_RXH_TSS2, CAR.PRIUS_TSS2}

# no resume button press required
NO_STOP_TIMER_CAR = TSS2_CAR | {CAR.PRIUS_V, CAR.LEXUS_CTH_SNG, CAR.RAV4H, CAR.HIGHLANDERH, CAR.HIGHLANDER, CAR.SIENNA, CAR.LEXUS_ESH}
