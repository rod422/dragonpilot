...
_DP_CRUISE_MAX_V = [3.5, 3.5, 3.2, 3.0, 2.6, 1.7, 1.5, 1.2, 0.75]
_DP_CRUISE_MAX_V_ECO = [3.5, 3.45, 2.2, 2.8, 2.2, 1.5, 1.1, 0.8, 0.4]
_DP_CRUISE_MAX_V_SPORT = [4.0, 3.5, 3.5, 3.0, 3.0, 2.5, 2.0, 1.5, 1.0]
