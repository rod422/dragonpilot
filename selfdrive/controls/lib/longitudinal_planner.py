...
_DP_CRUISE_MIN_V = [-2.0, -2.0, -2.0, -2.0, -1.8, -1.35, -0.25]
_DP_CRUISE_MIN_V_ECO = [-1.0, -1.0, -1.0, -1.0, -0.9, -0.5, -0.2]
_DP_CRUISE_MIN_V_SPORT = [-3.0, -3.0, -3.0, -3.0, -3.0, -2.0, -2.0]
_DP_CRUISE_MIN_BP = [0.0, 3.0, 5.0, 20.0, 33.3, 40.0, 55.0]

_DP_CRUISE_MAX_V = [3.5, 3.4, 3.2, 2.4, 2.6, 1.7, 0.8, 0.32, 0.09]
_DP_CRUISE_MAX_V_ECO = [3.5, 3.3, 3.1, 2.0, 2.2, 1.5, 0.6, 0.26, 0.087]
_DP_CRUISE_MAX_V_SPORT = [3.5, 3.5, 3.5, 3.0, 3.0, 3.0, 1.5, 0.5, 0.2]
_DP_CRUISE_MAX_BP = [0., 5., 8., 11., 15., 20., 25., 30., 55.]
